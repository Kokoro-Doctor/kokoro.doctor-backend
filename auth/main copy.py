...
#     verification_link = f"https://kokoro.doctor/verify-email?token={token}&email={email}"
#     subject = "Verify your email for Kokoro Doctor"
#     body = f"Click the link to verify your email: {verification_link}"

#     try:
#         ses.send_email(
#             Source="verify@kokoro.doctor",
...
#     ses.send_email(
#         Source="no-reply@kokoro.doctor",
#         Destination={"ToAddresses": [data.email]},
#         Message={
#             "Subject": {"Data": "Reset Your Password"},
#             "Body": {"Text": {"Data": f"Click to reset password: {reset_link}"}}
#         }
#     )
